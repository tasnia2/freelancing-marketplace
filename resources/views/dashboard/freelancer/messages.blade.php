...
.conversations-sidebar {
    background: var(--white);
    border-right: 1px solid var(--purple-pastel);
    display: flex;
...
.conversation-item.active {
    background: linear-gradient(90deg, rgba(123, 97, 255, 0.1) 0%, rgba(139, 92, 246, 0.05) 100%);
...
.empty-chat-icon {
    ...
    box-shadow: 0 15px 35px rgba(123, 97, 255, 0.3);
}
